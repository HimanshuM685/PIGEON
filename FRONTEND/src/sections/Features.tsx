...
import {
    Wallet, MessageCircle, Coins, KeyRound,
...
const features = [
    ...
    { title: 'Stablecoin Payments', icon: Coins, description: 'Pay using USDC.', className: 'col-span-12 md:col-span-4 bg-[var(--bg-pink)] text-white p-12' },
